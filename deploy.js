...
function updateRemoteApp() {
  return ssh.execCommand(
    'mkdir starter-node-angular-master && cp -r starter-node-angular-master-temp/* starter-node-angular-master/ && rm -rf starter-node-angular-master-temp', {
      cwd: '/home/ubuntu'
  });
}
...
function restartRemoteServices() {
  return ssh.execCommand(
    'cd starter-node-angular-master && sudo service mongod start && pm2 start app.js', {
      cwd: '/home/ubuntu'
  });
}
